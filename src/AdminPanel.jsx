...
const DEF_DISPLAY = {
  ...
  slideDuration:12, ticker:[], challenges:[], homeMessages:[],
...
export default function AdminPanel(){
  ...
  const handleLogin=(session)=>{ setStaffSession(session); getStaff().then(setStaffList); };
        ...
        <div className="mob-nav">
          <div className="mob-nav-inner">
            ...
            <button className="mob-nav-btn" onClick={handleLogout}>
              ...
              <span className="mob-nav-lbl">Out</span>
            </button>
          </div>
        </div>
